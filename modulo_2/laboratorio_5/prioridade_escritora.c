...
int vetor[TAM], N, M, lendo, escrevendo, quero_escrever;
...
void *leitora (void *arg) {
    ...
    while (1) {
        ...
        pthread_mutex_lock(&mutex);
        {
            ...
            while (escrevendo || quero_escrever) {
...
int main(int argc, char const *argv[])
{
    ...
    if (argc < 3) {
        fprintf(stderr, "Digite: %s <quantidade de leitoras> <quantidade de escritoras>\n", argv[0]);
        return 1;
    }
    ...
    lendo = 0; escrevendo = 0; quero_escrever = 0;
